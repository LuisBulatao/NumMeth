...
public class LagrangeInterpolation {
    ...
    public static void LagrangeFirstOrderInterpolation() {
        ...
        //Output
        System.out.println("\nInterpolated value at theGivenX =  " + "f" + "(" + (int)theGivenX + ")" + " = " + df.format(FiristOrderFormula));
    }
    ...
    public static void SecondOrderInterpolatin() {
        ...
        System.out.println("\nInterpolated value at theGivenX =  " + "f" + "(" + (int)theGivenX + ")" + " = " + df.format(SecondOrderFormula));
    }
    ...
    public static void NthOrderInterpolatin() {
        ...
        System.out.println("\nInterpolated value at theGivenX =  " + "f" + "(" + (int)theGivenX + ")" + " = " + df.format(nthOrderFormulaResult));
    }
}